var mainmenu = function(game) {
  ...
  this.sceneResFile="mainmenu.res"+'?'+ new Date().getTime();
  this.sceneNodeFile="mainmenu.scn"+'?'+ new Date().getTime();
  this.worldConfigFile="mainmenu.config"+'?'+ new Date().getTime();
