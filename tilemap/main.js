var main = function(game) {
  this.game = game;
  this.sceneName="main";
  this.sceneResFile="main.res"+'?'+ new Date().getTime();
  this.sceneNodeFile="main.scn"+'?'+ new Date().getTime();
  this.worldConfigFile="main.config"+'?'+ new Date().getTime();
