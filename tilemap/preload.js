var preload = function(game) {
  ...
  this.sceneResFile="preload.res"+'?'+ new Date().getTime();
  this.sceneNodeFile="preload.scn"+'?'+ new Date().getTime();
  this.worldConfigFile="preload.config"+'?'+ new Date().getTime();
